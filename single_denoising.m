...
valid_intervals = SignalExtract.detectValidIntervals(envelope_signal, time, locs_idx);
...
SignalExtract.plotSignalWithIntervals(time, envelope_signal, valid_intervals, 'title', '包络线及其有效区间', 'markers', [locs', peaks']);

SignalExtract.plotSignalWithIntervals(time, signal, valid_intervals, 'title', '原始信号及其有效区间', 'markers', [locs', signal(locs_idx)]);
